...
The directed edges of the graph express dissimilarity from the standpoint of one world to another. And the colored dots represent a set of facts, that each world has associated with it.
